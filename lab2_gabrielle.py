...
print(f"Exercise 4: 'The area of of circle with radius 2 is {area}.'")  
...
day_today = int(input("Please enter today's day number (0-6): "))
days_trip = int(input("Please enter the duration of your trip, in days: "))


print(f'''Exercise 5:
    Your trip starts on day {day_today} and lasts {days_trip} days. You will
    be back on day {(day_today+days_trip)%7}. Have a nice vacation!''')
